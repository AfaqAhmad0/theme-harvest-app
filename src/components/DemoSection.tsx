      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          <Card className="group border-2 p-8 text-center transition-all hover:border-primary hover:shadow-xl animate-fade-in">
            <div className="mb-5 inline-flex h-14 w-14 items-center justify-center rounded-full bg-primary/10 transition-colors group-hover:bg-primary">
              <Play className="h-7 w-7 text-primary transition-colors group-hover:text-primary-foreground" />
            </div>
          ...
          <Card className="group border-2 p-8 text-center transition-all hover:border-primary hover:shadow-xl animate-fade-in" style={{ animationDelay: "0.1s" }}>
            <div className="mb-5 inline-flex h-14 w-14 items-center justify-center rounded-full bg-primary/10 transition-colors group-hover:bg-primary">
              <Calendar className="h-7 w-7 text-primary transition-colors group-hover:text-primary-foreground" />
            </div>
          ...
          <Card className="group border-2 border-primary bg-primary/5 p-8 text-center transition-all hover:shadow-xl animate-fade-in" style={{ animationDelay: "0.2s" }}>
            <div className="mb-5 inline-flex h-14 w-14 items-center justify-center rounded-full bg-primary">
